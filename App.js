...
onPress={() => setInput('')}>
<Text style={styles.BtnText4}>AC</Text>
</TouchableOpacity>

<TouchableOpacity style={styles.BtnContainer}
onPress={borrarNums}>
<Text style={styles.BtnText1}>C</Text>
</TouchableOpacity>
...
<TouchableOpacity style={styles.BtnContainer}
onPress={() => numInput('*')}>
<Text style={styles.BtnText1}>x</Text>
</TouchableOpacity>
...
fontSize: 30,
padding: 15,
color: '#FF5733', // Cambiar color del texto de los botones
},
...
BtnText4:{
  fontSize: 20,
  padding: 15,
  color: '#C70039', // Cambiar color del texto de los botones
  },
